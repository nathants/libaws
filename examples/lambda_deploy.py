...
def main(event, context):
    """
      >> aws-lambda-deploy examples/lambda_deploy.py SOME_VAR=some_val --yes
      >> echo '{"foo": "bar"}' > /tmp/input
      >> aws-lambda-invoke examples/lambda_deploy.py --payload /tmp/input
         {'foo': 'bar'}
      >> aws-lambda-logs examples/lambda_deploy.py
         ...
         2018-03-02 00:08:50.375000 REPORT RequestId: efd7e55a-1df0-11e8-bdd2-d17e9059f5d9 Duration: 858.68 ms ...
    """
